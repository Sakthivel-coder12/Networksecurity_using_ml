...
from network_security.entity.artifact_entiy import (
...
class DataTransformation:
    ...
    def get_data_transformer_object(cls)->Pipeline:
        ...
        It initialises a KNNImputerobject object with the parameters specified in the training 
    ...
    def initiate_data_transformation(self)->DataTransformationArtifact:
        logging.info("Entered initiate_data_transformation method of dataTransforamtion class")
        try:
            ...
            save_numpy_array_data(self.data_transformation_config.transformed_object_file_path,array  = preprocessor_object)   
